...
export const watchSearchRecommendActions = {
  FETCH_WATCH_SEARCH_RECOMMENDS_REQUEST:
    "FETCH_WATCH_SEARCH_RECOMMENDS_REQUEST",
  FETCH_WATCH_SEARCH_RECOMMENDS_FAILURE:
    "FETCH_WATCH_SEARCH_RECOMMENDS_FAILURE",
  FETCH_WATCH_SEARCH_RECOMMENDS_SUCCESS:
    "FETCH_WATCH_SEARCH_RECOMMENDS_SUCCESS",
};
...
export const searchingActions = {
  ...
  FETCH_GET_SAVE_SEARCH_REQUEST: "FETCH_GET_SAVE_SEARCH_REQUEST",
  FETCH_GET_SAVE_SEARCH_FAILURE: "FETCH_GET_SAVE_SEARCH_FAILURE",
  FETCH_GET_SAVE_SEARCH_SUCCESS: "FETCH_GET_SAVE_SEARCH_SUCCESS",
  FETCH_DELETE_SAVED_SEARCH_REQUEST: "FETCH_DELETE_SAVED_SEARCH_REQUEST",
  FETCH_DELETE_SAVED_SEARCH_FAILURE: "FETCH_DELETE_SAVED_SEARCH_FAILURE",
...
export const postsActions = {
  ...
  FETCH_ADD_POSTS_REQUEST: "FETCH_ADD_POSTS_REQUEST",
  FETCH_ADD_POSTS_FAILURE: "FETCH_ADD_POSTS_FAILURE",
  FETCH_ADD_POSTS_SUCCESS: "FETCH_ADD_POSTS_SUCCESS",
  FETCH_EDIT_POSTS_REQUEST: "FETCH_EDIT_POSTS_REQUEST",
  FETCH_EDIT_POSTS_FAILURE: "FETCH_EDIT_POSTS_FAILURE",
  FETCH_EDIT_POSTS_SUCCESS: "FETCH_EDIT_POSTS_SUCCESS",
  FETCH_DELETE_POSTS_REQUEST: "FETCH_DELETE_POSTS_REQUEST",
  FETCH_DELETE_POSTS_FAILURE: "FETCH_DELETE_POSTS_FAILURE",
  FETCH_DELETE_POSTS_SUCCESS: "FETCH_DELETE_POSTS_SUCCESS",
};
...
export const friendActions = {
  ...
  FETCH_SET_REQUEST_FRIEND_REQUEST: "FETCH_SET_REQUEST_FRIEND_REQUEST",
  FETCH_SET_REQUEST_FRIEND_FAILURE: "FETCH_SET_REQUEST_FRIEND_FAILURE",
  FETCH_SET_REQUEST_FRIEND_SUCCESS: "FETCH_SET_REQUEST_FRIEND_SUCCESS",
  FETCH_SET_FRIEND_ACCEPT_REQUEST: "FETCH_SET_FRIEND_ACCEPT_REQUEST",
  FETCH_SET_FRIEND_ACCEPT_FAILURE: "FETCH_SET_FRIEND_ACCEPT_FAILURE",
  FETCH_SET_FRIEND_ACCEPT_SUCCESS: "FETCH_SET_FRIEND_ACCEPT_SUCCESS",
  FETCH_GET_USER_FRIENDS_REQUEST: "FETCH_GET_USER_FRIENDS_REQUEST",
  FETCH_GET_USER_FRIENDS_FAILURE: "FETCH_GET_USER_FRIENDS_FAILURE",
  FETCH_GET_USER_FRIENDS_SUCCESS: "FETCH_GET_USER_FRIENDS_SUCCESS",
  FETCH_SET_BLOCK_REQUEST: "FETCH_SET_BLOCK_REQUEST",
  FETCH_SET_BLOCK_FAILURE: "FETCH_SET_BLOCK_FAILURE",
  FETCH_SET_BLOCK_SUCCESS: "FETCH_SET_BLOCK_SUCCESS",
  FETCH_GET_LIST_BLOCK_REQUEST: "FETCH_GET_LIST_BLOCK_REQUEST",
  FETCH_GET_LIST_BLOCK_FAILURE: "FETCH_GET_LIST_BLOCK_FAILURE",
  FETCH_GET_LIST_BLOCK_SUCCESS: "FETCH_GET_LIST_BLOCK_SUCCESS",
};
...
export const userActions = {
  ...
  FETCH_GET_USER_INFO_REQUEST: "FETCH_GET_USER_INFO_REQUEST",
  FETCH_GET_USER_INFO_FAILURE: "FETCH_GET_USER_INFO_FAILURE",
  FETCH_GET_USER_INFO_SUCCESS: "FETCH_GET_USER_INFO_SUCCESS",
  FETCH_SET_USER_INFO_REQUEST: "FETCH_SET_USER_INFO_REQUEST",
  FETCH_SET_USER_INFO_FAILURE: "FETCH_SET_USER_INFO_FAILURE",
  FETCH_SET_USER_INFO_SUCCESS: "FETCH_SET_USER_INFO_SUCCESS",
};
...
export const likeActions = {
  FETCH_LIKE_REQUEST: "FETCH_LIKE_REQUEST",
  FETCH_LIKE_FAILURE: "FETCH_LIKE_FAILURE",
  FETCH_LIKE_SUCCESS: "FETCH_LIKE_SUCCESS",
};
export const commentActions = {
  FETCH_SET_COMMENT_REQUEST: "FETCH_SET_COMMENT_REQUEST",
  FETCH_SET_COMMENT_FAILURE: "FETCH_SET_COMMENT_FAILURE",
  FETCH_SET_COMMENT_SUCCESS: "FETCH_SET_COMMENT_SUCCESS",
  FETCH_GET_COMMENT_REQUEST: "FETCH_GET_COMMENT_REQUEST",
  FETCH_GET_COMMENT_FAILURE: "FETCH_GET_COMMENT_FAILURE",
  FETCH_GET_COMMENT_SUCCESS: "FETCH_GET_COMMENT_SUCCESS",
};
export const authActions = {
  ...
  FETCH_GET_VERIFY_CODE_REQUEST: "FETCH_GET_VERIFY_CODE_REQUEST",
  FETCH_GET_VERIFY_CODE_FAILURE: "FETCH_GET_VERIFY_CODE_FAILURE",
  FETCH_GET_VERIFY_CODE_SUCCESS: "FETCH_GET_VERIFY_CODE_SUCCESS",
  FETCH_CHECK_VERIFY_CODE_REQUEST: "FETCH_CHECK_VERIFY_CODE_REQUEST",
  FETCH_CHECK_VERIFY_CODE_FAILURE: "FETCH_CHECK_VERIFY_CODE_FAILURE",
  FETCH_CHECK_VERIFY_CODE_SUCCESS: "FETCH_CHECK_VERIFY_CODE_SUCCESS",
  FETCH_CHANGE_INFO_AFTER_SIGNUP_REQUEST: "FETCH_CHANGE_INFO_AFTER_SIGNUP_REQUEST",
  FETCH_CHANGE_INFO_AFTER_SIGNUP_FAILURE: "FETCH_CHANGE_INFO_AFTER_SIGNUP_FAILURE",
  FETCH_CHANGE_INFO_AFTER_SIGNUP_SUCCESS: "FETCH_CHANGE_INFO_AFTER_SIGNUP_SUCCESS",
...
export const chatActions = {
  FETCH_GET_CONVERSATION_REQUEST: "FETCH_GET_CONVERSATION_REQUEST",
  FETCH_GET_CONVERSATION_FAILURE: "FETCH_GET_CONVERSATION_FAILURE",
  FETCH_GET_CONVERSATION_SUCCESS: "FETCH_GET_CONVERSATION_SUCCESS",
  FETCH_GET_LIST_CONVERSATION_REQUEST: "FETCH_GET_LIST_CONVERSATION_REQUEST",
  FETCH_GET_LIST_CONVERSATION_FAILURE: "FETCH_GET_LIST_CONVERSATION_FAILURE",
  FETCH_GET_LIST_CONVERSATION_SUCCESS: "FETCH_GET_LIST_CONVERSATION_SUCCESS",
  FETCH_SET_READ_MESSAGE_REQUEST: "FETCH_SET_READ_MESSAGE_REQUEST",
  FETCH_SET_READ_MESSAGE_FAILURE: "FETCH_SET_READ_MESSAGE_FAILURE",
  FETCH_SET_READ_MESSAGE_SUCCESS: "FETCH_SET_READ_MESSAGE_SUCCESS",
  FETCH_DELETE_MESSAGE_REQUEST: "FETCH_DELETE_MESSAGE_REQUEST",
  FETCH_DELETE_MESSAGE_FAILURE: "FETCH_DELETE_MESSAGE_FAILURE",
  FETCH_DELETE_MESSAGE_SUCCESS: "FETCH_DELETE_MESSAGE_SUCCESS",
  FETCH_DELETE_CONVERSATION_REQUEST: "FETCH_DELETE_CONVERSATION_REQUEST",
  FETCH_DELETE_CONVERSATION_FAILURE: "FETCH_DELETE_CONVERSATION_FAILURE",
  FETCH_DELETE_CONVERSATION_SUCCESS: "FETCH_DELETE_CONVERSATION_SUCCESS",
  FETCH_ADD_DIALOG_REQUEST: "FETCH_ADD_DIALOG_REQUEST",
  FETCH_ADD_DIALOG_FAILURE: "FETCH_ADD_DIALOG_FAILURE",
  FETCH_ADD_DIALOG_SUCCESS: "FETCH_ADD_DIALOG_SUCCESS",
};
